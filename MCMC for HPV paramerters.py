    ...
    def simulate(data111):
        ...
        if difference != 0:
            ...
            for idx in range(abs(difference)):
                age = sorted_ages[idx % len(sorted_ages)][0]
        ...
        for ii in range(bisexual_msm_count):
            age = msm_nodes['age'][ii]
            msm_nodes['heterosexual_partners'][ii] = generate_heterosexual_partners(age)
        ...
        for iii in range(total_msm_nodes):
            age = msm_nodes['age'][iii]
            msm_nodes['same_sex_partners'][iii] = generate_same_sex_partners(age)
        ...
        def grasp_connect_female_male(network, female_nodes, male_nodes):
            ...
            while len(unconnected_female_nodes) > 0 and len(unconnected_male_nodes) > 0:
                ...
                if best_male_node is not None:
                    ...
                    if i in unconnected_female_nodes:
                        unconnected_female_nodes.remove(i) 
